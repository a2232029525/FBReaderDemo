    ...
    static void setGL16Mode(Activity a) {
        ...
        try {
            if (successful) {
                ...
                Object localRegionParams = RegionParamsConstructor.newInstance(new Object[]{0, 0, 600, 800, waveEnums[1]}); // Wave = GU
                ...
                if (DeviceType.Instance() == DeviceType.NOOK12) {
                    epdControllerSetRegionMethod.invoke(mEpdController, new Object[]{"FBReaderJ", regionEnums[2], localRegionParams, modeEnums[2]}); // Mode = ONESHOT_ALL
                }else {
                    epdControllerSetRegionMethod.invoke(null, new Object[]{"FBReaderJ", regionEnums[2], localRegionParams, modeEnums[2]}); // Mode = ONESHOT_ALL
                }
            }
        }catch (Exception e) {
            e.printStackTrace();
