...
public final class PositionWithTimestamp implements Parcelable {
    ...
    public PositionWithTimestamp(ZLTextPosition pos) {
        this(pos.getParagraphIndex(), pos.getElementIndex(), pos.getCharIndex(), (pos instanceof ZLTextFixedPosition.WithTimestamp) ? ((ZLTextFixedPosition.WithTimestamp)pos).Timestamp : -1);
    }
    ...
    public static final Creator<PositionWithTimestamp> CREATOR = new Creator<PositionWithTimestamp>() {
