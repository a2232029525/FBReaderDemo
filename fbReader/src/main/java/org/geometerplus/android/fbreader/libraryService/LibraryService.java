...
public class LibraryService extends Service {
    ...
    private static final class Observer extends FileObserver {
        ...
        private static final int MASK = MOVE_SELF | MOVED_TO | MOVED_FROM | DELETE_SELF | DELETE | CLOSE_WRITE | ATTRIB;
    ...
    public final class LibraryImplementation extends LibraryInterface.Stub {
        ...
        public List<String> books(String query) {
            return SerializerUtil.serializeBookList(myCollection.books(SerializerUtil.deserializeBookQuery(query)));
        }
        ...
        public void storePosition(long bookId, PositionWithTimestamp pos) {
            ...
            myCollection.storePosition(bookId, new ZLTextFixedPosition.WithTimestamp(pos.ParagraphIndex, pos.ElementIndex, pos.CharIndex, pos.Timestamp));
        }
        ...
        public List<String> bookmarks(String query) {
            return SerializerUtil.serializeBookmarkList(myCollection.bookmarks(SerializerUtil.deserializeBookmarkQuery(query, myCollection)));
        }
