...
public class FavoritesTree extends FilteredTree {
    ...
    public Status getOpeningStatus() {
        return Collection.hasBooks(new Filter.ByLabel(Book.FAVORITE_LABEL)) ? Status.ALWAYS_RELOAD_BEFORE_OPENING : Status.CANNOT_OPEN;
    }

    @Override
    public String getOpeningStatusMessage() {
        return getOpeningStatus() == Status.CANNOT_OPEN ? "noFavorites" : super.getOpeningStatusMessage();
    }
