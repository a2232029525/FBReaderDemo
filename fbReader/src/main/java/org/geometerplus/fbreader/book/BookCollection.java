...
public class BookCollection extends AbstractBookCollection<DbBook> {
    ...
    private final Map<ZLFile, DbBook> myBooksByFile = Collections.synchronizedMap(new LinkedHashMap<ZLFile, DbBook>());
    private final Map<Long, DbBook> myBooksById = Collections.synchronizedMap(new HashMap<Long, DbBook>());
    ...
    private final Map<Integer, HighlightingStyle> myStyles = Collections.synchronizedMap(new TreeMap<Integer, HighlightingStyle>());
    ...
    private void collectBooks(ZLFile file, FileInfoSet fileInfos, Map<Long, DbBook> savedBooksByFileId, Map<Long, DbBook> orphanedBooksByFileId, Set<DbBook> newBooks, boolean doReadMetaInfo) {
