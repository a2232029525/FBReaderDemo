...
public final class Bookmark extends ZLTextFixedPosition {
    ...
    public Bookmark(long id, String uid, String versionUid, long bookId, String bookTitle, String text, String originalText, long creationTimestamp, Long modificationTimestamp, Long accessTimestamp, String modelId, int start_paragraphIndex, int start_elementIndex, int start_charIndex, int end_paragraphIndex, int end_elementIndex, int end_charIndex, boolean isVisible, int styleId) {
    ...
    public String toString() {
        return "Bookmark{" +
                "myId=" + myId +
                ", Uid='" + Uid + '\'' +
                ", myVersionUid='" + myVersionUid + '\'' +
                ", BookId=" + BookId +
                ", BookTitle='" + BookTitle + '\'' +
                ", myText='" + myText + '\'' +
                ", myOriginalText='" + myOriginalText + '\'' +
                ", CreationTimestamp=" + CreationTimestamp +
                ", myModificationTimestamp=" + myModificationTimestamp +
                ", myAccessTimestamp=" + myAccessTimestamp +
                ", myEnd=" + myEnd +
                ", myLength=" + myLength +
                ", myStyleId=" + myStyleId +
                ", ModelId='" + ModelId + '\'' +
