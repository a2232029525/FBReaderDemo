...
public final class MimeType {
    ...
    public static final List<MimeType> TYPES_FB2 = Arrays.asList(APP_FICTIONBOOK, APP_FICTIONBOOK_XML, APP_FB2, APP_XFB2, APP_FB2_XML, TEXT_FB2);
    ...
    public static final List<MimeType> TYPES_PDF = Arrays.asList(APP_PDF, APP_XPDF, TEXT_PDF, APP_VND_PDF);
    public static final List<MimeType> TYPES_DJVU = Arrays.asList(IMAGE_VND_DJVU, IMAGE_XDJVU, APP_DJVU);
