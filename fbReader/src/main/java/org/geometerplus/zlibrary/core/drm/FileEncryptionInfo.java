...
public class FileEncryptionInfo {
    ...
    public boolean equals(Object other) {
        ...
        return ComparisonUtil.equal(Uri, oInfo.Uri) &&
    ...
    @Override
    public int hashCode() {
        return ComparisonUtil.hashCode(Uri) + 23 * (ComparisonUtil.hashCode(Method) + 23 * (ComparisonUtil.hashCode(Algorithm) + 23 * ComparisonUtil.hashCode(ContentId)));
    }
}
